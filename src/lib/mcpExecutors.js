...
export function get_policies() {
  return {
    ...
    bundle: `Buying any product from the gear-accessories category alongside a bike in the same order gets every bike in that order ${SITE.bundleDiscountPct}% off automatically -- no code needed. See ${absUrl('/shop/gear-accessories/')}.`,
    cryptoDiscountPct: SITE.cryptoDiscountPct,
    reservationDepositPct: SITE.reservationDepositPct,
    bundleDiscountPct: SITE.bundleDiscountPct,
